...
Description: Solves a type of puzzle cube known as a polycube puzzle by reducing it to a set cover problem and then applying Knuth's dancing links (DLX) algorithm. Associated Mathematica notebook discusses the problem and solution in a computational essay format alongside the source code. 
